...
import routes.natlan_swim_9 as route_module
from portals.natlan_swim_5 import PORTAL
...
VIDEO_BASE = os.environ.get("AUTO_VIDEO_BASE", os.path.join(PROJECT_ROOT, "Recordings", "swim"))
START_FROM = 0
